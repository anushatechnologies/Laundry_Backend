...
async function createTables() {
  ...
  await database.query(`
    CREATE TABLE IF NOT EXISTS pricing_settings (
      ...
      express_delivery_fee DECIMAL(10, 2), same_day_delivery_fee DECIMAL(10, 2) DEFAULT 160.00, extra_kg_price DECIMAL(10, 2),
  ...
  const alterMigrations: [string, string][] = [
    ...
    ['customer_addresses', 'ADD COLUMN latitude DECIMAL(10, 7) NULL'],
    ['customer_addresses', 'ADD COLUMN longitude DECIMAL(10, 7) NULL'],
    ...
    ['pricing_settings', 'ADD COLUMN delivery_calculation_mode VARCHAR(50) DEFAULT "DISTANCE_BASED"'],
    ['pricing_settings', 'ADD COLUMN base_distance_km INT DEFAULT 3'],
    ['pricing_settings', 'ADD COLUMN base_delivery_fee DECIMAL(10, 2) DEFAULT 30.00'],
    ['pricing_settings', 'ADD COLUMN per_km_rate_after_base DECIMAL(10, 2) DEFAULT 10.00'],
    ['pricing_settings', 'ADD COLUMN max_service_radius_km INT DEFAULT 35'],
    ['pricing_settings', "ADD COLUMN store_name VARCHAR(255) DEFAULT 'LaundryFresh Central Hub'"],
    ['pricing_settings', "ADD COLUMN store_address TEXT NULL"],
    ['pricing_settings', 'ADD COLUMN store_latitude DECIMAL(10, 7) DEFAULT 17.4929894'],
    ['pricing_settings', 'ADD COLUMN store_longitude DECIMAL(10, 7) DEFAULT 78.4144426'],
    ['pricing_settings', 'ADD COLUMN store_phone VARCHAR(50) NULL'],
    ['pricing_settings', 'ADD COLUMN distance_tiers JSON NULL'],
  ];
