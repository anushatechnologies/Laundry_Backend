...
async function publishRelease() {
  const apkPath = path.join(__dirname, '../../LaundryFresh-v1.0.42-release.apk');
  ...
  const s3Key = 'releases/LaundryFresh-v1.0.42-release.apk';
  ...
  const versionName = 'v1.0.42';
  const versionCode = 42;
  const fileName = 'LaundryFresh-v1.0.42-release.apk';
  const releaseNotes = 'v1.0.42: Zepto-style top toast alerts, persistent customer notification channel preferences in Settings, Bulk Laundry floating cart bar, and checkout enhancements.';
  ...
  console.log('\n========================================');
  console.log('RELEASE v1.0.42 PUBLISHED TO AWS SUCCESSFULLY!');
