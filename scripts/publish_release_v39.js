...
async function publishRelease() {
  const apkPath = path.join(__dirname, '../../LaundryFresh-v1.0.39-release.apk');
  ...
  const s3Key = 'releases/LaundryFresh-v1.0.39-release.apk';
  ...
  const versionName = 'v1.0.39';
  const versionCode = 39;
  const fileName = 'LaundryFresh-v1.0.39-release.apk';
  const releaseNotes = 'v1.0.39: Fix quantity stepper minus [-] and plus [+] icons visibility in dark mode on Product Detail screen with elevated dark slate buttons and high-contrast white vector icons.';
  ...
  console.log('\n========================================');
  console.log('RELEASE v1.0.39 PUBLISHED SUCCESSFULLY!');
