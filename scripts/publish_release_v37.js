...
async function publishRelease() {
  const apkPath = path.join(__dirname, '../../LaundryFresh-v1.0.37-release.apk');
  ...
  const s3Key = 'releases/LaundryFresh-v1.0.37-release.apk';
  ...
  const versionName = 'v1.0.37';
  const versionCode = 37;
  const fileName = 'LaundryFresh-v1.0.37-release.apk';
  const releaseNotes = 'v1.0.37: Comprehensive End-to-End Modern Dark Mode Redesign with deep obsidian surfaces, crisp white typography, adaptive headers, fixed white-on-white text, and sleek checkout cards across all customer screens.';
  ...
  console.log('\n========================================');
  console.log('RELEASE v1.0.37 PUBLISHED SUCCESSFULLY!');
