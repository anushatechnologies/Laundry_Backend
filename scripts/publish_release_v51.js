...
async function publishRelease() {
  const apkPath = path.join(__dirname, '../../LaundryFresh-v1.0.51-release.apk');
  ...
  const s3Key = 'releases/LaundryFresh-v1.0.51-release.apk';
  ...
  const versionName = 'v1.0.51';
  const versionCode = 51;
  const fileName = 'LaundryFresh-v1.0.51-release.apk';
  const releaseNotes = 'v1.0.51: Complete dynamic backend API catalog matching, authentic AWS S3 category/subcategory images, zero stock/placeholder photos, and performance enhancements.';
  ...
  console.log('\n========================================');
  console.log('RELEASE v1.0.51 PUBLISHED TO AWS & DB SUCCESSFULLY!');
