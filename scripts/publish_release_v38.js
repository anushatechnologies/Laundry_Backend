...
async function publishRelease() {
  const apkPath = path.join(__dirname, '../../LaundryFresh-v1.0.38-release.apk');
  ...
  const s3Key = 'releases/LaundryFresh-v1.0.38-release.apk';
  ...
  const versionName = 'v1.0.38';
  const versionCode = 38;
  const fileName = 'LaundryFresh-v1.0.38-release.apk';
  const releaseNotes = 'v1.0.38: Complete End-to-End Dark Mode overhaul across all 28 screens and core components (MiniBagDrawer, LocationSelectorModal, CustomAlert, BeforeAfterShowcase, ShimmerSkeleton) with deep obsidian surfaces, crisp typography, and seamless adaptive cards.';
  ...
  console.log('\n========================================');
  console.log('RELEASE v1.0.38 PUBLISHED SUCCESSFULLY!');
