...
async function publishRelease() {
  const apkPath = path.join(__dirname, '../../LaundryFresh-v1.0.50-release.apk');
  ...
  const s3Key = 'releases/LaundryFresh-v1.0.50-release.apk';
  ...
  const versionName = 'v1.0.50';
  const versionCode = 50;
  const fileName = 'LaundryFresh-v1.0.50-release.apk';
  const releaseNotes = 'v1.0.50: Tax Invoice buttons high-contrast overhaul for light and system themes, seamless video carousel banner playback, and vertical service options on product cards.';
  ...
  console.log('\n========================================');
  console.log('RELEASE v1.0.50 PUBLISHED TO AWS SUCCESSFULLY!');
