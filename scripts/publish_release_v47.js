...
async function publishRelease() {
  const apkPath = path.join(__dirname, '../../LaundryFresh-v1.0.47-release.apk');
  ...
  const s3Key = 'releases/LaundryFresh-v1.0.47-release.apk';
  ...
  const versionName = 'v1.0.47';
  const versionCode = 47;
  const fileName = 'LaundryFresh-v1.0.47-release.apk';
  const releaseNotes = 'v1.0.47: Hub-based dynamic delivery fee calculation, added service location Siri Sampada Arcade 1 (Khajaguda, Hyderabad - 500104), and silenced cart/wishlist toasts.';
  ...
  console.log('\n========================================');
  console.log('RELEASE v1.0.47 PUBLISHED TO AWS SUCCESSFULLY!');
