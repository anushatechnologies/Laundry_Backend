...
async function publishRelease() {
  const apkPath = path.join(__dirname, '../../LaundryFresh-v1.0.40-release.apk');
  ...
  const s3Key = 'releases/LaundryFresh-v1.0.40-release.apk';
  ...
  const versionName = 'v1.0.40';
  const versionCode = 40;
  const fileName = 'LaundryFresh-v1.0.40-release.apk';
  const releaseNotes = 'v1.0.40: Blinkit-style floating cart bar with live item thumbnails, animated ADD-to-stepper button transitions, and full in-app GST tax invoice viewer & PDF download options.';
  ...
  console.log('\n========================================');
  console.log('RELEASE v1.0.40 PUBLISHED TO AWS SUCCESSFULLY!');
