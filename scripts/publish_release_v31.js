...
async function publishRelease() {
  const apkPath = path.join(__dirname, '../../LaundryFresh-v1.0.31-release.apk');
  ...
  const s3Key = 'releases/LaundryFresh-v1.0.31-release.apk';
  ...
  const versionName = 'v1.0.31';
  const versionCode = 31;
  const fileName = 'LaundryFresh-v1.0.31-release.apk';
  const releaseNotes = 'v1.0.31: Removed floating cart buttons across screens, fixed BookScreen bag error, fixed search back navigation, enhanced Payment Retry modal UI.';
  ...
  console.log('\n========================================');
  console.log('RELEASE v1.0.31 PUBLISHED SUCCESSFULLY!');
