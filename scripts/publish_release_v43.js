...
async function publishRelease() {
  const apkPath = path.join(__dirname, '../../LaundryFresh-v1.0.43-release.apk');
  ...
  const s3Key = 'releases/LaundryFresh-v1.0.43-release.apk';
  ...
  const versionName = 'v1.0.43';
  const versionCode = 43;
  const fileName = 'LaundryFresh-v1.0.43-release.apk';
  const releaseNotes = 'v1.0.43: Zepto-style instant 0ms search, fixed zero price bug across garments, verified price matrix integration, emerald theme color consistency, and smooth back navigation.';
  ...
  console.log('\n========================================');
  console.log('RELEASE v1.0.43 PUBLISHED TO AWS SUCCESSFULLY!');
