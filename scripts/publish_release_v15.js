...
async function publishRelease() {
  const apkPath = path.join(__dirname, '../../LaundryFresh-v1.0.15-release.apk');
  ...
  const s3Key = 'releases/LaundryFresh-v1.0.15-release.apk';
  ...
  const versionName = 'v1.0.15';
  const versionCode = 15;
  const fileName = 'LaundryFresh-v1.0.15-release.apk';
  const releaseNotes = 'v1.0.15: 4-per-row circular category & service grids, Referral banner on Home & Profile, instant WhatsApp invite links, direct release APK updates.';
  ...
  console.log('\n========================================');
  console.log('RELEASE v1.0.15 PUBLISHED SUCCESSFULLY!');
