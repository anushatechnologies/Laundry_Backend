...
async function publishRelease() {
  const apkPath = path.join(__dirname, '../../LaundryFresh-v1.0.33-release.apk');
  ...
  const s3Key = 'releases/LaundryFresh-v1.0.33-release.apk';
  ...
  const versionName = 'v1.0.33';
  const versionCode = 33;
  const fileName = 'LaundryFresh-v1.0.33-release.apk';
  const releaseNotes = 'v1.0.33: Removed filter/tune icon completely from home search bar; Direct full-width search pill with green magnifying glass and crisp placeholder.';
  ...
  console.log('\n========================================');
  console.log('RELEASE v1.0.33 PUBLISHED SUCCESSFULLY!');
