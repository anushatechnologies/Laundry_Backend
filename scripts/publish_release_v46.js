...
async function publishRelease() {
  const apkPath = path.join(__dirname, '../../LaundryFresh-v1.0.46-release.apk');
  ...
  const s3Key = 'releases/LaundryFresh-v1.0.46-release.apk';
  ...
  const versionName = 'v1.0.46';
  const versionCode = 46;
  const fileName = 'LaundryFresh-v1.0.46-release.apk';
  const releaseNotes = 'v1.0.46: Fixed keyboard covering chat input bar on Android — input and quick prompts now slide above keyboard instantly.';
  ...
  console.log('\n========================================');
  console.log('RELEASE v1.0.46 PUBLISHED TO AWS SUCCESSFULLY!');
