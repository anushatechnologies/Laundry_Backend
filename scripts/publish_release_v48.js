...
async function publishRelease() {
  const apkPath = path.join(__dirname, '../../LaundryFresh-v1.0.48-release.apk');
  ...
  const s3Key = 'releases/LaundryFresh-v1.0.48-release.apk';
  ...
  const versionName = 'v1.0.48';
  const versionCode = 48;
  const fileName = 'LaundryFresh-v1.0.48-release.apk';
  const releaseNotes = 'v1.0.48: Enhanced product cards and product details with horizontal scrolling service pills, live rates, icons, tailored treatment benefits, and starch treatment awareness.';
  ...
  console.log('\n========================================');
  console.log('RELEASE v1.0.48 PUBLISHED TO AWS SUCCESSFULLY!');
