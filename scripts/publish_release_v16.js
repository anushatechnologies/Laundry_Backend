...
async function publishRelease() {
  const apkPath = path.join(__dirname, '../../LaundryFresh-v1.0.16-release.apk');
  ...
  const s3Key = 'releases/LaundryFresh-v1.0.16-release.apk';
  ...
  const versionName = 'v1.0.16';
  const versionCode = 16;
  const fileName = 'LaundryFresh-v1.0.16-release.apk';
  const releaseNotes = 'v1.0.16: Instant Fast2SMS OTP integration, Categories crash fix (null toLowerCase error resolved), strictly 4 items per row full-rounded circular grids, Referral banner and WhatsApp sharing.';
  ...
  console.log('\n========================================');
  console.log('RELEASE v1.0.16 PUBLISHED SUCCESSFULLY!');
