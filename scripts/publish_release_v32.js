...
async function publishRelease() {
  const apkPath = path.join(__dirname, '../../LaundryFresh-v1.0.32-release.apk');
  ...
  const s3Key = 'releases/LaundryFresh-v1.0.32-release.apk';
  ...
  const versionName = 'v1.0.32';
  const versionCode = 32;
  const fileName = 'LaundryFresh-v1.0.32-release.apk';
  const releaseNotes = 'v1.0.32: Fixed Home screen search bar width collapse; Fixed 100% Free Subscription Quota order booking; Hidden bottom tab bar during checkout stages with full-width action footer; Fixed button text truncation.';
  ...
  console.log('\n========================================');
  console.log('RELEASE v1.0.32 PUBLISHED SUCCESSFULLY!');
