...
async function publishRelease() {
  const apkPath = path.join(__dirname, '../../LaundryFresh-v1.0.34-release.apk');
  ...
  const s3Key = 'releases/LaundryFresh-v1.0.34-release.apk';
  ...
  const versionName = 'v1.0.34';
  const versionCode = 34;
  const fileName = 'LaundryFresh-v1.0.34-release.apk';
  const releaseNotes = 'v1.0.34: Proper UI for Proceed to Pickup & Slots (no tab bar overlap on Bag, full-width native dock with safe area), Back button on Bag header, and 100% transparent Bill Summary calculation showing subscription quota deduction and wallet line items.';
  ...
  console.log('\n========================================');
  console.log('RELEASE v1.0.34 PUBLISHED SUCCESSFULLY!');
