...
async function publishRelease() {
  const apkPath = path.join(__dirname, '../../LaundryFresh-v1.0.49-release.apk');
  ...
  const s3Key = 'releases/LaundryFresh-v1.0.49-release.apk';
  ...
  const versionName = 'v1.0.49';
  const versionCode = 49;
  const fileName = 'LaundryFresh-v1.0.49-release.apk';
  const releaseNotes = 'v1.0.49: Upgraded search precision engine with strict garment-intent filtering, English stemming (Sarees/Bedsheets), and strict email validation rejecting file extensions (.yml).';
  ...
  console.log('\n========================================');
  console.log('RELEASE v1.0.49 PUBLISHED TO AWS SUCCESSFULLY!');
